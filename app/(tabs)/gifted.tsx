...
import GiftedBatteryHistoryChart from "@/components/gifted/BatteryHistoryChart";
import GiftedExportImportChart from "@/components/gifted/ExportImportChart";
import GiftedHomeUsageChart from "@/components/gifted/HomeUsageChart";
import giftedNotes from "@/components/gifted/notes.md";
import GiftedSavingsChart from "@/components/gifted/SavingsChart";
...
export default function GiftedScreen() {
		...
		<ScrollView contentContainerStyle={styles.scrollContent}>
			<View style={styles.container}>
				...
				{selectedChart === "homeUsage" && (
					<GiftedHomeUsageChart theme={theme} />
				)}
				{selectedChart === "importExport" && (
					<GiftedExportImportChart theme={theme} />
				)}
				{selectedChart === "batteryHistory" && (
					<GiftedBatteryHistoryChart theme={theme} />
				)}
				{selectedChart === "savings" && <GiftedSavingsChart theme={theme} />}
				<NotesBox content={giftedNotes} />
			</View>
		</ScrollView>
	);
}
